...
<body class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
	...
	<div class="m-grid m-grid--hor m-grid--root m-page">
						...
						<div class="col-lg-12">
							<div class="m-portlet">
								...
								<div class="m-portlet__body">
												...
												<div class="form-group m-form__group row align-items-center">
													...
													<div class="col-md-5">
														<div class="m-input-icon m-input-icon--left">
															<input type="text" class="form-control m-input" placeholder="Cari Kode Transaksi" id="tbxSearchDetailTransaksi">
									...
									<!--end: Search Form -->
									<!--begin: Datatable -->
									<div class="m_datatable" id="divDetailTransaksiList"></div>
									<!--end: Datatable -->
								</div>
							</div>
						</div>
        ...
        <script src="<?php echo base_url()?>public/script/transaksi/detail.js" type="text/javascript"></script>
</body>
<!-- end::Body -->
